	...
	$.each(list, function(index, event) {
		//prikazuju se i aktivne i neaktivne
        	...
        	if(checkPoster==".jpg" || checkPoster==".png"){
        		tr.append('<td class="ac"><img width="100" height="120" class="lazyloaded" data-src="../images/' + event.poster + '" src="../images/' + event.poster + '" alt="' + event.poster + '"itemprop="image"></td>');
        	
        	}else{
        		tr.append('<td class="ac"><img width="100" height="120"  src="data:image/png;base64,'+event.poster+'" alt="' + event.poster + '" ></td>');
        	}
