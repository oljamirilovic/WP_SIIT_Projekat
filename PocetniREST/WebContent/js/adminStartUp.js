		...
		success : function(result){
			if(result!=null){
				...
				$.ajax({
					...
					success :function(){
						//TODO event window
						window.location.href = "http://localhost:8081/PocetniREST/html/adminEvent.html";
					},
...
function renderList(data){
	...
	$.each(list, function(index, event) {
		...
		var stat = (event.status) ? "ACTIVE" : "INACTIVE";
        ...
        tr.append('<td class="score ac fs14"><div><span class="text score-label score-na" ></span>' + stat + '</span></div></td>');
