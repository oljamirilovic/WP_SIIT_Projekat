...
function renderResult(data){
	...
	$('#location').append('<span class="numbers members"><button type="button" class="locationRow" style="" onclick="document.getElementById(\'id06\').style.display=\'block\'" id="'+ event.lokacija.geografskaDuzina + ' ' + event.lokacija.geografskaSirina +'" ><i class="fa fa-globe-americas"></i></button></span>');
