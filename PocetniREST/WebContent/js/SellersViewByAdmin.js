...
var rootURL3 = "../../PocetniREST/rest/salesmen/undoBlocking";
var rootURL4 = "../../PocetniREST/rest/salesmen/block";
		...
		if(!event.izbrisan){
                ...
                tr.append('<td class="notsus title ac va-c word-break" >' + event.ime + '</td>' +
                            ...
                            '<td class="notsus title ac va-c word-break">' + event.korisnickoIme + '</td>' +
                             '<td class="notsus title ac va-c word-break">' + event.datumRodjenja+ '</td>');
                
                if(event.blokiran){
					tr.append('<td class="notsus score ac fs14" ><div><span class="text score-label score-na" ><button class="undoBlockingTableRowBtn" onclick="document.getElementById(\'id02\').style.display=\'block\'" id="'+ event.korisnickoIme  +'" >Unblock</button></span></div></td>');
				}
				else{
					tr.append('<td class="notsus score ac fs14" ><div><span class="text score-label score-na" ><button class="blockTableRowBtn" onclick="document.getElementById(\'id03\').style.display=\'block\'" id="'+ event.korisnickoIme  +'" >Block</button></span></div></td>');
				}
				
				tr.append('<td class="notsus score ac fs14" ><div><span class="text score-label score-na" ><button class="deleteTableRowBtn" onclick="document.getElementById(\'id04\').style.display=\'block\'" id="'+ event.korisnickoIme  +'" >Delete</button></span></div></td>');
